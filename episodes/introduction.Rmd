...
to cover the basics, and we are assuming that you have a knowledge as if you have taken one of our <a href="https://kubdatalab.github.io/R-intro/" target="_blank">introductory courses</a>



know how to use the following  functionalities in R before starting this course:

If any of these topics are unfamiliar, we strongly recommend that you either 
take one of our <a href="https://kubdatalab.github.io/R-intro/" target="_blank">introductory courses</a>, 
...
- We begin by accessing an API using lowlevel methods, and end by using higher level methods.
